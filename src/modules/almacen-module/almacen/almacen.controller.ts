...
import { routeAlmacenCreate, routeAlmacenFindAll, routeAlmacenFindBy, routeAlmacenRemove, routeAlmacenUpdate } from 'src/common/utils/routes/almacen-module/almacen.route';
