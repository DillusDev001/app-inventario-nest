...
import { routeSucursalCreate, routeSucursalFindAll, routeSucursalFindBy, routeSucursalRemove, routeSucursalUpdate } from 'src/common/utils/routes/almacen-module/sucursal.route';
