...
import { routeCompraDetalleCreate, routeCompraDetalleFindAll, routeCompraDetalleFindBy, routeCompraDetalleRemove, routeCompraDetalleUpdate } from 'src/common/utils/routes/compradetalla.route';
